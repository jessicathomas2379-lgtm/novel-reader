...
export function IconTabbarHomeActive({ width = 24, height = 24, className, ...props }: IconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 22 22" fill="none" className={className} {...props}>
      <path d="M20.3996 4.91863L13.1032 0.505062C12.5702 0.183398 11.9612 0.00921433 11.3386 0.000355634C10.7161 -0.00850306 10.1024 0.148281 9.56044 0.454648L1.68201 4.91863C0.646223 5.50527 0 6.59606 0 7.75559V18.7093C0 20.5242 1.53077 22 3.40986 22H18.5892C20.4729 22 21.9991 20.5242 21.9991 18.7093V7.70976C21.9991 6.56856 21.4033 5.52819 20.3996 4.92321V4.91863ZM15.4177 16.8852H6.58139C6.12766 16.8852 5.76101 16.5415 5.76101 16.1198C5.76101 15.6982 6.12766 15.3544 6.58139 15.3544H15.4177C15.8714 15.3544 16.2381 15.6982 16.2381 16.1198C16.2381 16.5415 15.8714 16.8852 15.4177 16.8852Z" fill="url(#paint_tabbar_home)"/>
      <defs>
        <linearGradient id="paint_tabbar_home" x1="21.9991" y1="11" x2="-0.0116095" y2="11.0111" gradientUnits="userSpaceOnUse">
          <stop stopColor="#00C4E9"/>
          <stop offset="1" stopColor="#00EFB9"/>
        </linearGradient>
      </defs>
    </svg>
  );
...
export function IconTabbarProfileActive({ width = 24, height = 24, className, ...props }: IconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" className={className} {...props}>
      <path d="M20.4229 1.11133C21.5607 1.11133 22.4834 2.05672 22.4834 3.22266V11.667C22.4833 17.4966 17.871 22.2227 12.1816 22.2227H11.1514C5.46218 22.2225 0.84973 17.4965 0.849609 11.667C0.849609 5.83743 5.4621 1.1115 11.1514 1.11133H20.4229ZM8.5 9.55566C7.91703 9.55566 7.44434 10.0284 7.44434 10.6113V12.7227C7.44451 13.3055 7.91714 13.7783 8.5 13.7783C9.08281 13.7783 9.55549 13.3054 9.55566 12.7227V10.6113C9.55566 10.0284 9.08292 9.55572 8.5 9.55566ZM13.7773 9.55566C13.1946 9.55589 12.7227 10.0285 12.7227 10.6113V12.7227C12.7228 13.3053 13.1947 13.7781 13.7773 13.7783C14.3602 13.7783 14.8328 13.3055 14.833 12.7227V10.6113C14.833 10.0284 14.3603 9.55566 13.7773 9.55566Z" fill="url(#paint_tabbar_profile)"/>
      <defs>
        <linearGradient id="paint_tabbar_profile" x1="22.4834" y1="11.667" x2="0.849609" y2="11.667" gradientUnits="userSpaceOnUse">
          <stop stopColor="#00C4E9"/>
          <stop offset="1" stopColor="#00EFB9"/>
        </linearGradient>
      </defs>
